public class Kund {
    ...
    void purchase(double priCe) { // priCe will get the price of each item in merchandise, so that double priCe will refer to price in Merchandise class, and not kund
